# Valine Admin by wiidede

本仓库是fork于 [Druadach/Valine-Admin](https://github.com/Druadach/Valine-Admin)
...
4. ✨引入eslint
5. ✨async/await function，所有云函数都改为异步，逻辑更合理
6. ✨更详细的log输出
7. 旧的策略依旧有效，但这不是本项目的目的
